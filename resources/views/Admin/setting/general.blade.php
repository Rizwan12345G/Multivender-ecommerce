                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-0">
                                    ...
                                    <div class="upload-images upload-imagesprofile">
                                        <img src="{{ asset('admin/assets/img/user1.png')}}" alt="Image">
                                        <a href="javascript:void(0);" class="btn-icon logo-hide-btn">
                                            <i class="fa fa-times"></i>
                                        </a>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <h6 class="settings-size">Recommended image size is <span>800px x 600px</span></h6>
                                    <div class="upload-images ">
                                        <img src="{{ asset('admin/assets/img/logo1.png')}}" class="my-4" alt="Image">
                                        <a href="javascript:void(0);" class="btn-icon logo-hide-btn">
                                            <i class="fa fa-times"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="upload-images upload-imagesprofile">
                                        <img src="{{ asset('admin/assets/img/favicon.png')}}" class=" bg-white w-auto" alt="Image">
                                        <a href="javascript:void(0);" class="btn-icon logo-hide-btn">
                                            <i class="fa fa-times"></i>
                                        </a>
                                    </div>
