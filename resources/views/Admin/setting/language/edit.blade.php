...
@section('title', 'Admin-setting-language-edit')
                            ...
                            <div class="card-body">
                                ...
                                <form action="categories.html">
                                    <div class="form-group">
                                        <label>Name</label>
                                        <input class="form-control" type="text" placeholder="english" value="english">
                                    </div>
                                    <div class="form-group">
                                        <label>Code</label>
                                        <input class="form-control" type="text" placeholder="en" placeholder="en">
                                    </div>
                                    <div class="form-group">
