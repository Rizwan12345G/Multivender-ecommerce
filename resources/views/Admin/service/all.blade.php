                                    ...
                                    <table class="table table-hover table-center mb-0 datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-01.jpg')}}" alt=""> Toughened Glass Fitting Services
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-02.jpg')}}" alt=""> Car Repair Services
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-03.jpg')}}" alt=""> Electric Panel Repairing Service
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-04.jpg')}}" alt=""> Steam Car Wash
                                                    </a>
                                                </td>
                                                <td>Electra, Texas</td>
                                                <td>Car Wash</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-05.jpg')}}" alt=""> House Cleaning Service
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-06.jpg')}}" alt=""> Computer & Server AMC Service
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-07.jpg')}}" alt=""> Interior Designing
                                                    </a>
                                                </td>
                                                <td>Hanover, Maryland</td>
                                                <td>Interior</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-08.jpg')}}" alt=""> Building Construction Services
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-09.jpg')}}" alt=""> Commercial Painting Services
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-10.jpg')}}" alt=""> Plumbing Services
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-11.jpg')}}" alt=""> Wooden Carpentry Work
                                                    </a>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="service-details.html">
                                                        <img class="rounded service-img me-1" src="{{asset('admin/assets/img/services/service-12.jpg')}}" alt=""> Air Conditioner Service
                                                    </a>
                                                </td>
