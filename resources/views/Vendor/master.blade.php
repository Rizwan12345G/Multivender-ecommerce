        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        <li class="{{ Route::is('vendor.dashboard') ? 'active' : null }}">
                            <a href="{{ route('vendor.dashboard') }}"><i class="fas fa-columns"></i>
                                <span>Dashboard</span></a>
                        </li>
                        <li class="{{ Route::is('vendor.category.all') ? 'active' : null }}">
                            <a href="{{ route('vendor.category.all') }}"><i class="fas fa-layer-group"></i>
                                <span>Categories</span></a>
                        </li>
                        <li class="{{ route::is('vendor.product.all') ? 'active' : null }}">
                            <a href="{{ route('vendor.product.all') }}"><i class="fas fa-hashtag"></i>
